...
tags = ["虚拟机", "Hyper-V"]
image = "https://img.flinty.moe/blog/posts/2021/08/9985f7d1e11d45288630d75892bcf368/ryunosuke-kikuno-m6AbRqGmGCo-unsplash.avif"
+++
...
1. 将网络状态设置为专用
    ...
    ![](https://img.flinty.moe/blog/posts/2021/08/9985f7d1e11d45288630d75892bcf368/Untitled.avif)
    
2. 启用 Hyper-V 管理工具
    
    搜索“启用或关闭 Windows 功能”，打开
    
    ![](https://img.flinty.moe/blog/posts/2021/08/9985f7d1e11d45288630d75892bcf368/Untitled%201.avif)
    
    找到“Hyper-V 管理工具”，打钩，点击确定以安装功能（不需要安装 Hyper-V 平台）
    
    ![](https://img.flinty.moe/blog/posts/2021/08/9985f7d1e11d45288630d75892bcf368/Untitled%202.avif)
    
3. 将 Hyper-V Server 的 IP 地址添加到 HOSTS 记录
    
    先通过 hostname 命令查看 Hyper-V Server 主机名
    
    ![](https://img.flinty.moe/blog/posts/2021/08/9985f7d1e11d45288630d75892bcf368/Untitled%203.avif)
...
4. 修改组策略
    ...
    ![](https://img.flinty.moe/blog/posts/2021/08/9985f7d1e11d45288630d75892bcf368/Untitled%204.avif)
    ...
    ![](https://img.flinty.moe/blog/posts/2021/08/9985f7d1e11d45288630d75892bcf368/Untitled%205.avif)
...
6. 使用 Hyper-V 管理器连接到服务器
    ...
    ![](https://img.flinty.moe/blog/posts/2021/08/9985f7d1e11d45288630d75892bcf368/Untitled%206.avif)
    
    点击“设置用户...”，在弹出的窗口中，输入 Hyper-V Server 的用户名和密码。这边注意，如果 Server 没有加域，需要在名称前添加 .\，比如“.\Administrator”
    
    ![](https://img.flinty.moe/blog/posts/2021/08/9985f7d1e11d45288630d75892bcf368/Untitled%207.avif)
    
7. 链接成功
    
    ![](https://img.flinty.moe/blog/posts/2021/08/9985f7d1e11d45288630d75892bcf368/Untitled%208.avif)
